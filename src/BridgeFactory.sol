...
contract BridgeFactory {
    event Locked(
        address indexed sender, address indexed user, address indexed token, uint256 amount, uint256 targetChainId
    );
    ...
    function unwrap(address wrappedToken, uint256 amount, uint256 targetChainId) external {
